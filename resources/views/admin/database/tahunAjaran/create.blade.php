    ...
    <div class="container mx-auto">
        <div class="flex justify-center mt-6">
            <div class="container w-2/5">
                <h2 class="text-primary text-2xl font-semibold text-center">Tambah Tahun Ajaran</h2>
                <div class="bg-primary container h-1 mb-5 mt-2"></div>
                <form method="POST" action="/admin/database/tahun">
                    @csrf
                        ...
                        <div class="flex justify-evenly">
                            ...
                            <div class="text-center mt-12">
                                <button type="submit" class="bg-primary w-24 rounded-2xl hover:bg-red-300 text-white"
                                    onclick="return confirm('Yakin ingin menambahkan data tahun?')">Simpan</button>
                            </div>
                        </div>
                    </div>
                </form>
