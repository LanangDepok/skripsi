    ...
    <div class="container mx-auto">
        <div class="flex justify-center mt-6">
            <div class="container w-2/5">
                <h2 class="text-primary text-2xl font-semibold text-center">Edit Kelas</h2>
                <div class="bg-primary container h-1 mb-5 mt-2"></div>
                <form method="POST" action="{{ route('adm.updateKelas', ['kelas' => $data->id]) }}">
                    @csrf
                    @method('PUT')
                    <div class="container border-2 border-primary p-12 rounded-lg shadow-slate-400 shadow-lg">
                        <div class="text-left mb-4">
                            <label for="nama">Kelas<span class="text-red-700">*</span></label>
                            <input type="text"
                        ...
                        <div class="flex justify-evenly">
                            ...
                            <div class="text-center mt-12">
                                <button type="submit" class="bg-primary w-24 rounded-2xl hover:bg-red-300 text-white"
                                    onclick="return confirm('Yakin ingin mengubah data kelas?')">Edit</button>
                            </div>
                        </div>
                    </div>
                </form>
