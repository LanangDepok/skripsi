...
@section('content')
    <p class="text-center font-semibold text-2xl text-primary">Monitoring Sidang Sempro</p>
            ...
            <tbody>
                ...
                @foreach ($data as $index => $sempro)
                    <tr class="even:bg-slate-300">
                        ...
                        <td class="border-b border-slate-500 py-2 text-center">
                            {{ $sempro->pengajuanSemproMahasiswa->mahasiswa->tahun->nama }}</td>
                        <td class="border-b border-slate-500 py-2 text-center">
                        ...
                        <td class="border-b border-slate-500 py-2 text-center">
                            <a href="{{ route('adm.getSempro', ['pengajuanSempro' => $sempro->id]) }}"
