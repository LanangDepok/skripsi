    ...
    <div class="container mx-auto">
        <div class="flex w-1/2 mx-auto">
            <button class="bg-primary text-white hover:text-black hover:bg-red-300 w-20 h-8 rounded-xl"><a
                    href="/admin/pengajuan/alat">Back</a></button>
        </div>
        ...
        <div class="container mx-auto w-1/2 mt-6">
            <p class="text-3xl font-semibold text-center mb-10">Skripsi</p>
            <iframe src="/storage/assets/Draf 4-Pro-Bagas Rizkiyanto.pdf" class="w-full h-[600px]"></iframe>
            <div class="h-1 bg-primary mt-20"></div>
        </div>
        <div class="container mx-auto w-1/2 mt-6">
            <p class="text-3xl font-semibold text-center mb-10">F12</p>
            <iframe src="/storage/assets/f12.pdf" class="w-full h-[600px]"></iframe>
            <div class="h-1 bg-primary mt-20"></div>
        </div>
        <div class="container mx-auto w-1/2 mt-6">
            <p class="text-3xl font-semibold text-center mb-10">F13</p>
            <iframe src="/storage/assets/f13.pdf" class="w-full h-[600px]"></iframe>
            <div class="h-1 bg-primary mt-20"></div>
        </div>
        <div class="container mx-auto w-1/2 mt-6">
            <p class="text-3xl font-semibold text-center mb-10">F14</p>
            <iframe src="/storage/assets/f14.pdf" class="w-full h-[600px]"></iframe>
            <div class="h-1 bg-primary mt-20"></div>
        </div>
    </div>
@endsection
