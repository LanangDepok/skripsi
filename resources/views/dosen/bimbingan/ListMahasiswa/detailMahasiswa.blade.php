...
@section('content')
    <div class="container mx-auto">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('storage/' . (isset($bimbingan->bimbinganMahasiswa->mahasiswa->photo_profil) ? $bimbingan->bimbinganMahasiswa->mahasiswa->photo_profil : 'icons/user.png')) }}"
        ...
        <div class="container mx-auto w-1/2 mt-6">
            @if ($bimbingan->bimbinganMahasiswa->skripsi->file_skripsi != null)
                <iframe src="{{ asset('storage/' . $bimbingan->bimbinganMahasiswa->skripsi->file_skripsi) }}"
