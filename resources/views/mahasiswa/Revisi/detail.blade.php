    ...
    <div class="container mx-auto">
        <div class="flex w-1/2 mx-auto">
            <button class="bg-primary text-white hover:text-black hover:bg-red-300 w-20 h-8 rounded-xl"><a
                    href="/mahasiswa/revisi">Back</a></button>
        </div>
        ...
        <div class="container w-1/2 mx-auto mt-6">
            <p class="font-semibold text-lg">Hasil revisi :</p>
            <textarea disabled class="w-full border border-primary rounded-md" rows="10">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Debitis cupiditate modi consequatur! Facere, dolores expedita! Aliquid commodi libero hic, molestiae voluptatibus asperiores a repudiandae quo perspiciatis quasi quis. Doloribus vitae temporibus, animi repellendus quia dignissimos! Perferendis ut voluptas id ullam dolore aperiam, repudiandae porro dignissimos, ea iste harum voluptatem molestiae.
            </textarea>
            <div class="h-1 bg-primary"></div>
        </div>
