...
@section('content')
    ...
    <div class="container ml-auto mr-10">
        <div class="border-4 border-black w-20 ml-auto">
            <p class="text-4xl font-semibold text-center">F7a</p>
        </div>
    </div>
            ...
            <table class="table-auto mx-auto w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border border-slate-500 py-2 text-center">
                            {{ $pengajuanSkripsi->{'1a1'} +
                                $pengajuanSkripsi->{'1a2'} +
                                $pengajuanSkripsi->{'1a3'} +
                                $pengajuanSkripsi->{'1b1'} +
                                $pengajuanSkripsi->{'1b2'} +
                                $pengajuanSkripsi->{'1b3'} +
                                $pengajuanSkripsi->{'1b4'} +
                                $pengajuanSkripsi->{'1b5'} }}
                        </td>
                    </tr>
                </tbody>
            </table>
