...
@section('content')
    ...
    <div class="container ml-auto mr-10">
        <div class="border-4 border-black w-20 ml-auto">
            <p class="text-4xl font-semibold text-center">F7c</p>
        </div>
    </div>
    ...
    <div class="container w-full mx-auto mt-10 mb-20">
            ...
            <table class="table-auto mx-auto w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border border-slate-500 py-2 text-center">{{ $pengajuanSkripsi->{'3a1'} }}</td>
                    </tr>
                    <tr>
                        ...
                        <td class="border border-slate-500 py-2 text-center">{{ $pengajuanSkripsi->{'3a2'} }}</td>
                    </tr>
                    <tr>
                        <td class="border border-slate-500 py-2">Sesuai dengan format penulisan (A3)</td>
                        <td class="border border-slate-500 py-2 text-center">4,5 - 10</td>
                        <td class="border border-slate-500 py-2 text-center">{{ $pengajuanSkripsi->{'3a3'} }}</td>
                    </tr>
                    <tr>
                        ...
                        <td class="border border-slate-500 py-2 text-center">
                            {{ $pengajuanSkripsi->{'3a1'} + $pengajuanSkripsi->{'3a2'} + $pengajuanSkripsi->{'3a3'} }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="border border-slate-500 py-2 text-center">{{ $pengajuanSkripsi->{'3b1'} }}</td>
                    </tr>
                    <tr>
                        <td class="border border-slate-500 py-2">Pembangunan Alat/Program Aplikasi(B2)</td>
                        <td class="border border-slate-500 py-2 text-center">5,5 - 15</td>
                        <td class="border border-slate-500 py-2 text-center">{{ $pengajuanSkripsi->{'3b2'} }}</td>
                    </tr>
                    <tr>
                        ...
                        <td class="border border-slate-500 py-2 text-center">{{ $pengajuanSkripsi->{'3b3'} }}</td>
                    </tr>
                    <tr>
                        <td class="border border-slate-500 py-2">PengoperasianAlat/Program Aplikasi(B4)</td>
                        <td class="border border-slate-500 py-2 text-center">5,5 - 10</td>
                        <td class="border border-slate-500 py-2 text-center">{{ $pengajuanSkripsi->{'3b4'} }}</td>
                    </tr>
                    <tr>
                        <td class="border border-slate-500 py-2">Penyajian Alat/Program Aplikasi (B5)</td>
                        <td class="border border-slate-500 py-2 text-center">5,5 - 15</td>
                        <td class="border border-slate-500 py-2 text-center">{{ $pengajuanSkripsi->{'3b5'} }}</td>
                    </tr>
                    <tr>
                        <td class="border border-slate-500 py-2 text-center font-semibold" colspan="2">
                        ...
                        <td class="border border-slate-500 py-2 text-center">
                            {{ $pengajuanSkripsi->{'3b1'} + $pengajuanSkripsi->{'3b2'} + $pengajuanSkripsi->{'3b3'} + $pengajuanSkripsi->{'3b4'} + $pengajuanSkripsi->{'3b5'} }}
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-slate-500 py-2 text-center font-semibold" colspan="2">
                        ...
                        <td class="border border-slate-500 py-2 text-center">
                            {{ $pengajuanSkripsi->{'3a1'} +
                                $pengajuanSkripsi->{'3a2'} +
                                $pengajuanSkripsi->{'3a3'} +
                                $pengajuanSkripsi->{'3b1'} +
                                $pengajuanSkripsi->{'3b2'} +
                                $pengajuanSkripsi->{'3b3'} +
                                $pengajuanSkripsi->{'3b4'} +
                                $pengajuanSkripsi->{'3b5'} }}
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="mt-3">
            ...
            <p>NIP.{{ $pengajuanSkripsi->pengajuanSkripsiPenguji3->dosen->nip }}2342424234223424</p>
        </div>
        <div class="mt-3">
