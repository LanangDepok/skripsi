...
@section('content')
    ...
    <div class="container ml-auto mr-10">
        <div class="border-4 border-black w-20 ml-auto">
            <p class="text-4xl font-semibold text-center">F1</p>
        </div>
    </div>
    ...
    <div class="container w-full mx-auto mt-10 mb-20">
        ...
        <div class="mt-3">
            <p>Sesuai dengan persyaratan yang diatur dalam Pedoman Skripsi Jurusan Teknik informatika dan Komputer, maka
                ...
                {{ $pengajuanSempro->pengajuanSemproMahasiswa->mahasiswa->tahun_ajaran }}</p>
        </div>
        <div class="mt-3">
            <p>Depok, {{ $pengajuanSempro->acc_dospem }}</p>
            <p>Pembimbing,</p>
            <img class="max-w-32 max-h-24"
                src="/storage/{{ $pengajuanSempro->pengajuanSemproDospem->dosen->tanda_tangan }}">
